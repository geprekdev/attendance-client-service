...
export default function TeacherActivity() {
  const { isSuccess, data, isError, error, isLoading } = useGetActivityQuery({
  ...
  return (
    <Layout role="STUDENT">
      <div className="mx-auto min-h-screen max-w-[444px] border px-5 py-3 shadow-lg">
        <div className="flex items-center justify-between rounded-full bg-gradient-to-r from-blue-700 to-[#82a4f4] px-5 py-2 ">
